...
final List<BuildingData> kBuildings = [
  ...
  BuildingData(
    ...
    color: Colors.blue,
    floors: [
      FloorData(floor: '12F', rooms: ['생활관 (Dormitory)']),
      FloorData(floor: '3~11F', rooms: ['생활관 (Dormitory)']),
      FloorData(floor: '2F', rooms: ['생활관(장애인) (Dormitory (Disabled))']),
      FloorData(
        floor: '1F',
        rooms: [
      ...
      FloorData(
        ...
        rooms: [
          ...
          '택배 보관실 (Delivery storage)',
          '물품 보관실 (Storage room)',
          '세탁실 (Laundry room)',
          '관리사무실 (Management Office)',
        ],
      ),
    ],
  ),
    ...
    floors: [
      ...
      FloorData(
        ...
        rooms: [
          ...
          '330 독어교육과 학과사무실',
          '331 불어교육과 학과사무실',
          '333 대학원연구실(교육사회 및 평생교육전공)',
          '334 대학원연구실(교육행정전공)',
          '335 대학원연구실(특수교육전공)',
          '336 교육과학연구소',
          '337 교육학과사무실',
          '340 대학원연구실(교육철학및교육사전공)',
          '341 대학원연구실(사회과교육)',
          '342 대학원연구실(초등사회과교육전공)',
          '342-1 공동강의실(인문대학원)',
          '343-1 영어교육과 임용고사준비실',
          '343-2 영어교육과 임용고사준비실',
        ],
      ...
      FloorData(
        ...
        rooms: [
          '101 음향도서실 및 개별학습실',
          '102 대학원연구실(초·중등 영어전공)',
          '103 강의실',
          '104 강의실',
          '105 강의실',
          '106 대학원연구실(국어교육전공)',
          '107 국어교육과 세미나실 I',
          '107-1 국어교육과 문서 및 기자재보관실',
          '108 윤리교육전공실습실',
          '108-1 일반사회교육전공실습실',
          '109 대학원연구실(초등도덕)',
          '109-1 대학원연구실(역사교육전공)',
  ...
  BuildingData(
    ...
    floors: [
      ...
      FloorData(
        floor: '3F',
        rooms: [
          '301 한국근대교육사연구센터 (중점연구소)',
          '302 인문사회과학교육연구소 (중점연구소)',
          '303 특수교육과 강의실',
          '304 창고(제4대학)',
          '305 특수교육과 학생회실',
          '306 학장실(제4대학)',
  ...
  BuildingData(
    ...
    floors: [
      FloorData(
        floor: '6F',
        rooms: ['자연·예체능자료실 (500, 600, 700)', '특수자료실, 청람교사자료실'],
      ),
      FloorData(floor: '5F', rooms: ['사회과학자료실 상호대차 (300, 900, 학술지)']),
      FloorData(
        floor: '4F',
        rooms: ['인문과학자료실 (000, 100, 200, 400, 800)', '복사실'],
      ),
      FloorData(
        floor: '3F',
        rooms: ['교육학자료실 도서관회원제 (370, 교과용도서, 임용수험도서)', '해다미정원'],
      ),
      FloorData(
        floor: '2F',
        rooms: [
      ...
      FloorData(
        floor: 'R (B1)',
        rooms: ['시민휴(休) (아동도서)', '시민열람실1·2', '소공연장, 보존서고', '청람아트홀'],
      ),
    ],
  ),
  BuildingData(
